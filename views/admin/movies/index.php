<?php
/**
 * Vista: Lista de Películas (Admin) - Con iconos y modal
 */
$pageTitle = 'Películas';
        ...
        <table class="w-full min-w-[800px]">
            <thead class="bg-white/5">
                <tr>
                    ...
                    <th class="text-left p-4 font-medium">Duración</th>
            ...
            <tbody class="divide-y divide-white/5">
                ...
                <tr class="hover:bg-white/5">
                    ...
                    <td class="p-4 text-gray-400"><?= !empty($movie['duration']) ? formatDuration($movie['duration']) : '-' ?></td>
                    ...
                    <td class="p-4">
                        <div class="flex items-center justify-end gap-2">
                            <a href="<?= url('admin/movies/edit/' . $movie['id']) ?>" 
                            ...
                            <button onclick="openDeleteModal(<?= $movie['id'] ?>, '<?= e(addslashes($movie['title'])) ?>')" 
    ...
    <div class="absolute inset-0 flex items-center justify-center p-4">
        <div class="relative bg-[#1a1a1a] rounded-2xl p-6 max-w-md w-full border border-white/10">
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold mb-2">¿Eliminar película?</h3>
                <p class="text-gray-400 mb-6">Estás a punto de eliminar "<span id="movieTitle" class="text-white font-medium"></span>". Esta acción no se puede deshacer.</p>
...
function openDeleteModal(id, title) {
    ...
    document.getElementById('deleteLink').href = '<?= url('admin/movies/delete/') ?>' + id;
